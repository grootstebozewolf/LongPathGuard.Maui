...
public class LongPathGuardSteps
{
    ...
    {
        // Mirrors Concordia WinRT / CommunityToolkit source-generator output under obj.
        // The pipeline builds Release only; these files are compile-time scaffolding, not
        // native assets copied to the iOS payload.
        ...
        var needed = 201 - dir.Length - 1 /* separator */;
    ...
    public void GivenALongNativeAssetExistsInTheNuGetPackageCache()
    {
        ...
        var needed = 201 - shaderDir.Length - 1 /* separator */;
